...
},{"./templates/clipping.hbs":23,"./templates/layout.hbs":24,"./templates/title.hbs":25,"hbsfy/runtime":21,"whatwg-fetch":22}],2:[function(require,module,exports){
'use strict';
...
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<header>\n	<h1>Klippings</h1>\n	<div>"
    + container.escapeExpression(((helper = (helper = helpers.titleCount || (depth0 != null ? depth0.titleCount : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"titleCount","hash":{},"data":data}) : helper)))
    + " titles</div>\n<header>\n<main id=\"main\">\n</main>";
},"useData":true});
